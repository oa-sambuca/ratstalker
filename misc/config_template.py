...
class Config:
    ...
    class OAQuery:
        ...
        hosts       : list  = [
                ...
                ("96.126.107.177", 27202),  # /N/ProMode
                ("172.105.75.224", 27966),  # /N/City UK
                ("172.105.75.224", 27961),  # /N/ALLMODES UK|FFA
                ("172.105.75.224", 27963),  # /N/Duel UK
                ("172.105.75.224", 27960),  # /N/Deathmatch UK
                ("172.105.75.224", 27962),  # /N/try hard UK|CTF
                ("172.105.75.224", 27965),  # /N/INSTA CTF UK
                ("172.105.75.224", 27964),  # /N/CTF UK
                ("172.105.75.224", 27968)   # /N/CA UK|CA
                ]
